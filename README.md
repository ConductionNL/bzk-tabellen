...
Description
----
The National Tables Component provides access to the national index tables of BZK (NL), where you can find municipal numbers, for example. In this sense, it provides for making non-Common Ground sources available via API.
